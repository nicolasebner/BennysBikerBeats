...
const bigPlayButton = document.querySelector(".pos-one");
const player = document.querySelector("#iFrameEl");
const playIconInBigPlayButton = document.querySelector(".play-button");

const iFramePlayer = SC.Widget(iFrameEl);
...
bigPlayButton.addEventListener("click", function () {
  ...
  iFramePlayer.toggle();
  //Swaps Icon
  playIconInBigPlayButton.classList.toggle("fa-play");
  playIconInBigPlayButton.classList.toggle("fa-pause");
});
